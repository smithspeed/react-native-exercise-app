...
import { StyleSheet, Text, View, SafeAreaView, StatusBar, Image, TextInput, FlatList, TouchableOpacity } from 'react-native';
...
let exercises = [
    ...
    },
    {
        ...
        subTitle:'Live happier and healthier by learning the fundamentals of kegel exercises',
        duration: '10-20 MIN Course',
    },
    {
        title: 'Meditation',
        image: require('../assets/images/Exercise3.png'),
        subTitle:'Live happier and healthier by learning the fundamentals of meditation and mindfulness',
    ...
    return (
        <SafeAreaView style={{flex: 1, position: 'relative'}}>
            ...
            >
                ...
                <Text style={{fontSize: 30, lineHeight: 45, color : 'black'}}>
                ...
                >
                    <FontAwesome5Icons
                        ...
                        color={'black'}
                    />
                    <TextInput placeholder="Search" style={{flex: 1,color:'black'}} />
                </View>
                <View
                    style={{
                        width: 60,
