    ...
    return (
        <SafeAreaView style={{flex: 1, position: 'relative'}}>
            ...
            >
                ...
                />
                <Text style={{fontSize: 30, lineHeight: 45,color : 'black'}}>{exercise.title}</Text>
                <Text style={{fontSize: 16, opacity: 0.6, marginVertical: 10, color : 'black'}}>
                    {exercise.duration}
                </Text>
                <Text style={{fontSize: 16, width: '85%', color : 'black'}}>{exercise.subTitle}</Text>
                <View
                    style={{
                        flexDirection: 'row',
                        alignItems: 'center',
            ...
            <View style={{marginTop: -30, marginHorizontal: 30}}>
                ...
                />
                <Text style={{marginVertical: 15, fontSize: 20, color : 'black'}}>{exercise.title}</Text>
                <View
                    style={{
                        flexDirection: 'row',
                        alignItems: 'center',
                ...
                >
                    ...
                    />
                    <View>
                        <Text style={{color : 'black'}}>Basic 2</Text>
                        <Text style={{color : 'black'}}>Start your deepen you practice</Text>
                    </View>
                </View>
            </View>
        </SafeAreaView>
